        ...
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="lg:w-1/2 space-y-12">
            <div className="space-y-4">
              ...
              <h2 className="text-4xl md:text-6xl font-black tracking-tighter uppercase text-brand-navy">UNE EXPÉRIENCE <br /> TRANSFORMATRICE</h2>
            </div>
          ...
          <div className="lg:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="glass-card p-10 rounded-[2rem] reveal delay-100">
              <div className="w-14 h-14 bg-brand-navy/10 rounded-2xl flex items-center justify-center mb-8">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-brand-navy" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
              </div>
